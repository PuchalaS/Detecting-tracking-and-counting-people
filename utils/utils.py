...
class DataGenerator(Sequence):
    ...
    def __init__(self,
        ...
        self.batch_size =cfg.TRAIN.BATCH_SIZE  * self.num_gpu
        self.target_img_size = (cfg.TRAIN.INPUT_SIZE, cfg.TRAIN.INPUT_SIZE, 3)
        self.anchors = np.array(cfg.YOLO.ANCHORS).reshape((9, 2))
