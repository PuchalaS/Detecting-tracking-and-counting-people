...
from layers.custom_layers import yolov4_neck, yolov4_head, nms
from utils.utils import load_weights, get_detection_data, draw_bbox, voc_ap, draw_plot_func, read_txt_to_list
from config.defaults import cfg
from modeling.loss import yolo_loss
...
class Yolov4(object):
    def __init__(self,
        ...
        self.img_size = (cfg.TRAIN.INPUT_SIZE, cfg.TRAIN.INPUT_SIZE, 3)
    ...
    # raw_img: RGB
    def predict_img(self, raw_img, random_color=False, plot_img=False, figsize=(10, 10), show_text=True, return_output=False):
